...
const dataSet = require('../testData/UI_008_NonPlanedBasedIaCScanK8sRepo.json')

describe('UI-008: Non-Plan based IaC scan (KS8 repo - search and select) without cloud account associated - Validate KPIs', () => {
