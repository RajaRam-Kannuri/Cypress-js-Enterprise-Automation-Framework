...
const dataSet = require('../testData/UI_005_PlanbasedIacScanAzure.json')

describe('Plan based IaC scan  with cloud account associated AZURE - Validate KPIs', () => {
  ...
  dataSet.forEach(jsonData=> {
    if(jsonData.suite.includes(testSuiteName)) {
      it(jsonData.testcasename, () => {
        ...
        projectRepository.navigateAndVerifyTheRepoWithProject(projectName, jsonData.repositoryName)
