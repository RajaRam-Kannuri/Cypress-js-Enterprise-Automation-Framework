...
const dataSet = require('../testData/UI_006_NonPlanedBasedIaCScanTerraformRepo.json')

describe('UI-006: Non-Plan based IaC scan (terraform repo - search and select) without cloud account associated - Validate KPIs', () => {
